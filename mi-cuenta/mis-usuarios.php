...
$meta_title = 'Mis usuarios';

$page_slug = 'mis-usuarios';
include 'inc/verify-user-permissions.php';

if ($_SESSION['session_user_children_id']) :
...
<body class="bg-gray-01">
          ...
          <div class="p-2">
            ...
            <div class="card">
              <div class="card-header">
                ...
                <?php include 'modals/my-users.php'; ?>
                <?php include 'modals/permissions.php'; ?>
              </div>
  ...
  <script src="main/my-users/my-users.js"></script>
  <script src="main/my-users/validate.js"></script>
</body>
