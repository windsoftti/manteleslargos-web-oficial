                        ...
                        <div class="row">
                          <div class="col-12 col-sm-4 col-lg-6">
                            <div class="form-group">
                              ...
                              <input id="businessName" name="businessName" type="text" validate>
                            </div>
                          </div>
                        </div>

                        <div class="row salon-type type-hidden">
                          <div class="col-6 col-sm-4 col-lg-3">
                            <div class="form-group">
                              <label for="minCapacity">Capacidad min<span>*</span></label>
                              <input id="minCapacity" class="number-input" name="minCapacity" min="1" type="number" validate>
                            </div>
                          </div>
                          ...
                          <div class="col-6 col-sm-4 col-lg-3">
                            <div class="form-group">
                              ...
                              <input id="maxCapacity" class="number-input" name="maxCapacity" min="2" type="number" inputLabel="Capacidad max" greaterThan="minCapacity" greaterThanLabel="Capacidad mín." validate>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          <div class="col-12">
                            <div class="form-group">
                              ...
                              <textarea id="businessDescription" name="businessDescription" rows="8" validate></textarea>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="col-12 col-sm-6">
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                ...
                                <input id="businessCellPhone" class="number-input" name="businessCellPhone" maxlength="10" aria-describedby="prefixCellPhone" type="text" validate>
                              </div>
                            </div>
                          </div>
                        </div>
                    ...
                    <div class="col-12 col-sm-10 col-lg-12 mx-auto">
                      <div class="cs-card">
                        ...
                        <div id="package-list" class="row">
                          <?php /* Descomentar esto para que los paquetes vuelvan a ser obligatorios, hay que tambien descomentar numPackages en el js
                    ...
                    <div class="col-12 col-sm-10 mx-auto">
                      <div class="cs-card">
                        ...
                        <div class="row">
                          ...
                          <div id="city-container" class="col-12 col-sm-6" style="display: none;">
                            <div class="form-group">
                              <label for="city">Ciudad/Municipio<span>*</span></label>
                              <select id="city" class="select2" name="city" validate></select>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="map" style="width: 100%;">
                          <div id="business-map" style="width: 100%;height: 18rem;"></div>
                        </div>

                        <input id="latitude-business-map" type="hidden" name="latitude" labelError="Ubique su negocio en el mapa o en el buscador" validate>
                        <input id="longitude-business-map" type="hidden" name="longitude" labelError="Ubique su negocio en el mapa o en el buscador" validate>

                        <div class="form-group">
                          <input id="address-business-map" name="address" placeholder="Direccción" type="text" labelError="Escribe tu dirección" validate>
                        </div>
                      </div>
                    </div>
                  </div>
                      ...
                      <div class="cs-card">
                        ...
                        <div class="row">
                          <div class="col-12 col-lg-6">
                            <div class="form-group">
                              <div id="businessLogo" data-name="businessLogo" data-title="<span style='color:red'>*</span>Adjuntar imagen principal" data-subtitle="La imagen debe de ser de 600x600 de lo contrario la imagen será rechazada" data-labelError="Ajunta el logo de tu negocio (Opcional)" data-required="false"></div>
                            </div>
                          </div>
