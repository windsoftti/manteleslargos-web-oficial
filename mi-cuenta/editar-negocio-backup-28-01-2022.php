            ...
            <div class="collapse-tabs new-property-step">
              <ul class="nav nav-pills border py-2 px-3 mb-6 d-none d-md-flex mb-6" role="tablist">
                <li class="nav-item col">
                  <a class="nav-link active bg-transparent shadow-none py-2 font-weight-500 text-center lh-214 d-block" id="tipo-proveedor-tab" data-number="1." href="#tipo-proveedor" data-toggle="pill" role="tab" aria-controls="tipo-proveedor" aria-selected="false"><span class="number">-</span> Tipo de proveedor</a>
                </li>
                    ...
                    <div class="tab-pane tab-pane-parent fade show active px-0" id="tipo-proveedor" role="tabpanel" aria-labelledby="tipo-proveedor-tab">
                      <div class="card bg-transparent border-0">
                        <div class="card-header d-block d-md-none bg-transparent px-0 py-1 border-bottom-0" id="heading-tipo-proveedor">
                          <h5 class="mb-0">
                            <button type="button" class="btn btn-lg collapse-parent btn-block border shadow-none" data-target="#tipo-proveedor-collapse" aria-expanded="true" aria-controls="tipo-proveedor-collapse" data-number="1.">
                              Tipo de proveedor
                            </button>
                          </h5>
                        </div>
                                    ...
                                    <div class="row">
                                      <div class="col-sm-6 col-md-6">
                                        <div class="form-group">
                                          ...
                                          <input type="text" name="negocio" class="form-control form-control-lg border-0" id="negocio" value="<?= $data_neg['Salon'] ?>">
                                        </div>
                                      </div>
                                    ...
                                    <div class="row">
                                      <!-- <div class="col-sm-12 col-md-6 tipo-salon">
                                        <div class="form-group">
                                          ...
                                          <input type="number" name="costo" class="number-input form-control form-control-lg border-0" id="costo" value="<?= $data_neg['CostoRenta'] ?>">
                                        </div>
                                      </div> -->
                                      ...
                                      <div class="col-xs-12 col-sm-6 col-md-3 tipo-salon">
                                        <div class="form-group">
                                          ...
                                          <input type="number" name="capacidad" class="number-input form-control form-control-lg border-0" id="capacidad" value="<?= $data_neg['Capacidad'] ?>">
                                        </div>
                                      </div>
                                      ...
                                      <div class="col-xs-12 col-sm-6 col-md-3 tipo-salon">
                                        <div class="form-group">
                                          ...
                                          <input type="number" name="capacidadMaxima" class="number-input form-control form-control-lg border-0" id="capacidadMaxima" value="<?= $data_neg['CapacidadMaxima'] ?>">
                                        </div>
                                      </div>
                                    </div>
                                    ...
                                    <div class="row">
                                      <div class="col-sm-12 col-md-12">
                                        <div class="form-group">
                                          ...
                                          <textarea name="descripcion" id="descripcion" rows="8" class="form-control form-control-lg border-0"><?= base64_decode($data_neg['Descripcion']); ?></textarea>
                                        </div>
                                      </div>
                                    </div>
                                    ...
                                    <div class="row">
                                      <div class="col-sm-12 col-md-6">
                                        <div class="form-group">
                                          ...
                                          <input type="text" name="facebook" class="form-control form-control-lg border-0" id="facebook" placeholder="ej: https://www.facebook.com/perfil" value="<?= $data_neg['Facebook'] ?>">
                                        </div>
                                      </div>
                                      ...
                                      <div class="col-sm-12 col-md-6">
                                        <div class="form-group">
                                          ...
                                          <input type="text" name="instagram" class="form-control form-control-lg border-0" id="instagram" placeholder="ej: https://www.instagram.com/perfil" value="<?= $data_neg['Instagram'] ?>">
                                        </div>
                                      </div>
                                    </div>
                                  </div>
                            ...
                            <div class="d-flex flex-wrap mt-4">
                              ...
                              <div id="btn-next-tab">
                                <?php if ($data_neg['Tipo'] == 'Salon') : ?>
                                  <button type="button" class="btn btn-lg btn-primary next-button mb-3" onclick="showUbicacion()">Continuar
                                    <span class="d-inline-block ml-2 fs-16"><i class="fal fa-long-arrow-right"></i></span>
                                  </button>
                                <?php endif; ?>
                                ...
                                <div class="card border-0 shadow-xxs-2">
                                  <div class="card-body p-6">
                                    ...
                                    <div class="row">
                                      <div class="col-sm-12 col-md-4">
                                        <div class="form-group">
                                          ...
                                          <select name="perteneceATuxtla" id="perteneceATuxtla" class="form-control form-control-lg border-0">
                                            <option value="">Seleccionar</option>
                                            <option <?php if ($data_neg['PerteneceATuxtla'] == 'Si') { ?> selected <?php } ?> value="Si">Si</option>
                                            <option <?php if ($data_neg['PerteneceATuxtla'] == 'No') { ?> selected <?php } ?> value="No">No</option>
                                          </select>
                                        </div>
                                      </div>
                                      ...
                                      $query_result = mysqli_query($mysqli, $query);
                                      $display = $data_neg['PerteneceATuxtla'] == 'No' ? 'block' : 'none';
                                      ?>
                                      <div class="col-sm-12 col-md-4 municipio" style="display: <?= $display ?>;">
                                        <div class="form-group">
                                          ...
                                          <select name="idMunicipio" id="idMunicipio" class="form-control form-control-lg border-0">
                                            <option value="">Seleccionar</option>
                                            <?php while ($row = mysqli_fetch_array($query_result)) : ?>
                                              <option <?php if ($data_neg['idMunicipio'] == $row['idMunicipio']) { ?> selected <?php } ?> value="<?= $row['idMunicipio'] ?>"><?= $row['Municipio'] ?></option>
                                            <?php endwhile; ?>
                                          </select>
                                        </div>
                                      </div>
                                      ...
                                      <!-- <div class="col-sm-12 col-md-4">
                                        <div class="form-group">
                                          ...
                                          <select name="orientacion" id="orientacion" class="form-control form-control-lg border-0">
                                            <option value="">Seleccionar</option>
                                            <option <?php if ($data_neg['Orientacion'] == 'Norte / Poniente') { ?> selected <?php } ?> value="Norte / Poniente">Norte / Poniente</option>
                                            <option <?php if ($data_neg['Orientacion'] == 'Sur / Poniente') { ?> selected <?php } ?> value="Sur / Poniente">Sur / Poniente</option>
                                            <option <?php if ($data_neg['Orientacion'] == 'Norte / Oriente') { ?> selected <?php } ?> value="Norte / Oriente">Norte / Oriente</option>
                                            <option <?php if ($data_neg['Orientacion'] == 'Sur / Oriente') { ?> selected <?php } ?> value="Sur / Oriente">Sur / Oriente</option>
                                          </select>
                                        </div>
                                      </div> -->
                                    </div>
                                    ...
                                    <div class="row">
                                      <div class="col-sm-12 col-md-12 mt-2">
                                        <div class="form-group">
                                          ...
                                          <input type="text" name="direccion" id="direccion" class="form-control form-control-lg border-0" value="<?= $data_neg['Direccion'] ?>">
                                        </div>
                                      </div>
                                    </div>
                                  </div>
