        ...
        <main id="content" class="bg-gray-01">
          <div class="p-3">
            ...
            <div class="collapse-tabs new-property-step">
              <ul class="nav nav-pills border py-2 px-3 mb-6 d-none d-md-flex mb-6 d-flex align-items-center" role="tablist">
                                  ...
                                  <div class="card">
                                    <div class="card-body align-middle">
                                      <div class="custom-control custom-checkbox">
                                        <input class="custom-control-input" type="checkbox" id="all-tipoEventos" value="all">
                                        <label class="custom-control-label text-heading mb-0 fs-15 lh-15" for="all-tipoEventos">
                                ...
                                <?php while ($row = mysqli_fetch_array($query_result)) : ?>
                                  <div class="col-sm-6 col-md-4 mb-2">
                                    <div class="card">
                                      <div class="card-body align-middle">
                                        <div class="custom-control custom-checkbox">
                                          <input type="checkbox" class="custom-control-input check-tipoEvento" name="tipoEvento[]" id="tipoEvento-<?= $row['idTipoEvento'] ?>" value="<?= $row['idTipoEvento'] ?>">
                                          <label class="custom-control-label text-heading mb-0 fs-15 lh-15" for="tipoEvento-<?= $row['idTipoEvento'] ?>">
                                            <?= $row['TipoEvento'] ?>
                                          </label>
                                        </div>
                                      </div>
                              ...
                              <div class="col-lg-8 mx-auto">
                                <div class="card border-0 shadow-xxs-2">
                                  <div class="card-body p-6">
                                    <h3 class="card-title mb-3 text-heading fs-22 lh-15">Información básica de tu negocio</h3>
                                      ...
                                      <div class="col-md-4">
                                        <div class="form-group">
                                          ...
                                          <select id="estado" class="form-control form-control-lg select2" name="estado">
                                            <option value="">Seleccionar</option>
                                            <?php while ($row = mysqli_fetch_array($query_result)) :
                                              $estado_selected = $row['idEstado'] == 7 ? 'selected' : '';
                                            ?>
                                              <option <?= $estado_selected; ?> value="<?= $row['idEstado']; ?>"><?= $row['Estado']; ?></option>
                                            <?php endwhile; ?>
                                          </select>
                                        </div>
                                      </div>
                                            ...
                                            <div class="card">
                                              <div class="card-body align-middle">
                                                <div class="custom-control custom-checkbox">
                                                  ...
                                                  <label class="custom-control-label text-heading mb-0 fs-15 lh-15" for="servicio-<?= $row['idServicio'] ?>">
                                                    <?= $row['Servicio'] ?>
                                                  </label>
                                                </div>
                                              </div>
                                            ...
                                            <div class="card">
                                              <div class="card-body align-middle">
                                                <div class="custom-control custom-checkbox">
                                                  ...
                                                  <label class="custom-control-label text-heading mb-0 fs-15 lh-15" for="amenidad-<?= $row['idAmenidad'] ?>">
                                                    <?= $row['Amenidad'] ?>
                                                  </label>
                                                </div>
                                              </div>
          ...
          <!-- PAGE LOADING -->
          <?php include 'inc/page-preloading.php' ?>
        </main>
      </div>
    </div>
  </div>
