<div class="modal fade" id="modal-tips">
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <form id="tips-form" class="modal-content needs-validation" autocomplete="off">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="form-group">
              ...
              <textarea id="longDescription" class="form-control" name="longDescription" rows="15" required></textarea>
            </div>
          </div>
        </div>
