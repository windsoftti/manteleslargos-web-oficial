...
<body class="navbar-white">
            ...
            <div id="tab-direct-contact">
              <form id="direct-contact-form" autocomplete="off">
                ...
                <div class="form-group">
                  ...
                  <textarea id="contactMessage" name="contactMessage" rows="5">Hola, vi tu información en manteleslargos.com y me gustaría contratar sus servicios.</textarea>
                </div>
  ...
  <script src="<?= BASE_URL; ?>/src/js/businessv2.js"></script>
