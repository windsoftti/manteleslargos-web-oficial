...
$invitation = getInvitationDataForTemplateBySlug($invitation_slug, '03');
...
<head>
  ...
  <link rel="stylesheet" href="<?= BASE_URL; ?>/src/css/pages/invitation-template-03.css">
...
<body class="grid-container">
  ...
  <nav id="navbar" class="navbar">
    <div>
      <a class="navbar-brand" href="#">
        <b><?= $invitation['NombrePersona']; ?> te invitan a:</b><br><?= $invitation['NombreEvento']; ?>
      </a>
  ...
  <section class="event-title">
    ...
    <h3 class="white large"><?= $invitation['NombreEvento']; ?></h3>
      ...
      <?php if ($invitation['CRLugar']) : ?>
        <div>
          ...
          <div class="content">
            ...
            <p class="date-label"><?= getDateTimeWithStrFormat($invitation['CRFechaWithOutFormat']); ?></p>
      ...
      <?php if ($invitation['RLugar']) : ?>
        <div>
          ...
          <div class="content">
            ...
            <p><?= getDateTimeWithStrFormat($invitation['RFechaWithOutFormat']); ?></p>
