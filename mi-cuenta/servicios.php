...
<body class="bg-gray-01">
        ...
        <main id="content" class="bg-gray-01">
          <div class="p-2">
            ...
            <div class="card">
                    ...
                    <div class="col-md-6">
                      <div class="input-group input-group-lg bg-white border">
                        <div class="input-group-prepend">
                          <button class="btn pr-0 shadow-none" type="button" onclick="searchServices()"><i class="far fa-search"></i></button>
                        </div>
                        <input type="text" id="search-by-service" class="form-control bg-transparent border-0 shadow-none text-body" placeholder="Buscar tipo de evento" name="searchByService" onkeyup="searchServices()">
                      </div>
                    </div>
                  </form>

                  <div class="col-md-3 text-right mt-1">
                    <button class="btn btn-primary btn-add-service" data-toggle="modal" data-target="#modal-add-edit-service">
              ...
              <div class="card-body" id="list-services"></div>
            </div>
          </div>
  ...
  <script src="main/services/services.js"></script>
  <script src="main/services/validate.js"></script>
</body>
