...
$meta_title = 'Cotizaciones';

$page_slug = 'cotizaciones';
...
<body class="bg-gray-01">
          ...
          <div class="p-2">
            ...
            <div class="card">
              <div class="card-header">
                <div class="row align-middle">
                    ...
                    <div class="col-md-6">
                      <div class="input-group input-group-lg bg-white border">
                        <div class="input-group-prepend">
                          <button class="btn pr-0 shadow-none" type="button" onclick="searchQuotes()"><i class="far fa-search"></i></button>
                        </div>
                        <input type="text" id="search-by-quote" class="form-control bg-transparent border-0 shadow-none text-body" placeholder="Buscar (folio), (Nombre)" name="searchByQuote" onkeyup="searchQuotes()">
                      </div>
                    </div>
                  </form>
                  ...
                  <?php if ($session_user_plan === 'Básico') : ?>
                    <div class="col-md-3 text-right mt-1">
                      <button class="btn btn-primary btn-add-quote" data-toggle="modal" data-target="#modal-add-edit-quote">
                ...
                <?php include 'modals/quotes.php'; ?>
              </div>

              <div class="card-body" id="list-quotes"></div>
            </div>
          </div>
  ...
  <script src="main/quotes/quotes.js"></script>
  <script src="main/quotes/validate.js"></script>

  <?php if ($session_user_plan === 'Básico') : ?>
    <script src="main/quotes/add-edit-quotes.js"></script>
  <?php endif; ?>
