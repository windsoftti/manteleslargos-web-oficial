...
if ($_SESSION['session_user_level'] === 'Usuario') :
  ...
  $query_result_vs = mysqli_query($mysqli, "SELECT SUM(Visitas) as visitas FROM salones WHERE idUsuario = '$idUsuario'  AND Status = 'Activo'");
        ...
        <main id="content" class="bg-gray-01">
          <div class="px-3 px-lg-6 px-xxl-13 py-5 py-lg-10">
            ...
            <?php if ($_SESSION['session_user_level'] === 'Usuario') : ?>
              <div class="d-flex flex-wrap flex-md-nowrap mb-6">
                <div class="mr-0 mr-md-auto">
                  <h2 class="mb-0 text-heading fs-22 lh-15">Mira como ha crecido tus empresas</h2>
                  <p>Aqui puedes ver como todos tus negocios ha crecido en la plataforma</p>
                </div>
