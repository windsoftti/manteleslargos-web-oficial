...
$meta_title = 'Panel';
$personal_name = explode(' ', $_SESSION['session_user_name']);
...
if ($_SESSION['session_user_level'] === 'Usuario') :
  ...
  $query_result_ns = mysqli_query($mysqli, "SELECT idSalon FROM salones WHERE idUsuario = '$idUsuario' AND Status = 'Activo'");
  $rowcount_ns    = mysqli_num_rows($query_result_ns);

  // numero de visitas a su negocio
  $query_result_vs = mysqli_query($mysqli, "SELECT SUM(Visitas) as visitas FROM salones WHERE idUsuario = '$idUsuario' AND idSalon = $business_id  AND Status = 'Activo'");
  $row_vs          = mysqli_fetch_array($query_result_vs);

  // numero de cotizaciones pendientes
  $query_result_cs = mysqli_query($mysqli, "SELECT idCotizacion FROM cotizaciones WHERE idProveedor = '$idUsuario' AND idNegocio = $business_id  AND Status = 'Pendiente'");
  $rowcount_cs    = mysqli_num_rows($query_result_cs);

  // numero de ventas concretadas
  $query_result_ec = mysqli_query($mysqli, "SELECT idReservacion FROM reservaciones WHERE idUsuario = '$idUsuario' AND idNegocio = $business_id ");
        ...
        <main id="content" class="bg-gray-01">
          <div class="px-3 px-lg-6 px-xxl-13 py-5 py-lg-10">
              ...
              <div class="d-flex flex-wrap flex-md-nowrap mb-6">
                ...
                <div>
                  <a href="nueva-invitacion" class="btn btn-primary btn-lg">
                    <span>Agregar nueva invitación</span>
            ...
            <?php if ($_SESSION['session_user_level'] === 'Usuario') : ?>
              ...
              <?php if ($session_supplier_access['status'] == 'no-business') : ?>
                <div class="col-md-4 mx-auto">
                  <a href="./agregar-negocio" class="btn btn-primary btn-lg">
                    <span>Agrega tu primer negocio</span>
                    <span class="d-inline-block ml-1 fs-20 lh-1"><svg class="icon icon-add-new">
                        <use xlink:href="#icon-add-new"></use>
                      </svg></span>
                  </a>
              ...
              <?php if ($session_supplier_access['status'] == 'logged') : ?>
                <div class="row">
                    ...
                    <div class="col-xxl-4 mb-6">
                      <div class="card px-7 py-6 h-100">
                        <div class="card-body p-0">
                          <h2 class="mb-2 text-heading fs-22 lh-15">Recordatorio de eventos</h2>
