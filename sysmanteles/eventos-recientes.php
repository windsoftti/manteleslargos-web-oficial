...
<head>
  ...
  <link rel="stylesheet" href="https://code.jquery.com/ui/1.13.1/themes/pepper-grinder/jquery-ui.css">
...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <form id="search-form" class="row" autocomplete="off">
                    ...
                    <div class="col-md-3 d-flex align-items-center justify-content-end p-1">
                      <div class="dropdown">
                        <div class="btn-group">
                          <button type="button" class="btn btn-primary btn-add-recent-event" data-toggle="modal" data-target="#modal-recent-events">
                ...
                <?php include 'src/modals/recent-events.php'; ?>

                <div class="card-body p-0">
                  <div id="list-recent-events"></div>
                </div>
              </div>
            </div>
          </div>
  ...
  <script src="src/js/recent-events.js"></script>
</body>
