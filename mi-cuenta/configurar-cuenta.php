            ...
            <div class="row">
              <div class="col-12 col-md-4">
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-12 px-4 pb-4 text-center border-bottom">
                        <i class="fal fa-user-circle fa-5x mb-2"></i>

                        <h3 class="card-title fs-18 m-0"><?= $full_name; ?></h3>
                      </div>
                    </div>
              ...
              <div class="col-12 col-md-8">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title fs-22 mb-5">Datos personales</h4>
