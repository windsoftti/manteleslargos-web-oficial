...
if (!empty($_SESSION['account_verified_success'])) {
...
<head>
  ...
  <link rel="stylesheet" href="<?= BASE_URL; ?>/src/css/sticky-step.css">
  ...
  <style>
    ...
    /*Estilos modal cuenta validada con éxito*/
    #account-verified-modal #close-success-modal{
      margin: 0 auto;
    }
...
<body class="navbar-white">
  ...
  <main class="main">
    ...
    <!--MODAL CUENTA VALIDADA CON ÉXITO-->
    <div id="account-verified-modal" class="custom-modal">
      <div class="custom-modal-content">
        ...
        <h3>Cuenta validada con éxito</h3>
        ...
        <button id="close-success-modal" class="btn btn-primary">
          Continuar
        </button>
...
createEditor(); */
  ...
  document.addEventListener('DOMContentLoaded', function() {
      const modal = document.getElementById('account-verified-modal');
