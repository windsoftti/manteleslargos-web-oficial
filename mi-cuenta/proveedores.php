                  ...
                  <form id="search-filters-form" class="col-md-9 text-left">
                    <div class="col-md-6">
                      <div class="input-group input-group-lg bg-white border">
                        ...
                        <input type="text" id="search-by-user" class="form-control bg-transparent border-0 shadow-none text-body" placeholder="Buscar proveedor" name="searchByUser" onkeyup="searchUsers()">
                        <input type="hidden" id="type" name="type" value="proveedor">
                      </div>
                    </div>
                  </form>
