...
<body class="grid-container">
  ...
  <nav id="navbar" class="navbar">
    <div>
      <a class="navbar-brand" href="#">
        <b><?= $invitation['names']; ?> te invitan a:</b><br><?= $invitation['eventName']; ?>
      </a>
  ...
  <section class="event-title">
    ...
    <h3 class="white large"><?= $invitation['eventName']; ?></h3>
  ...
  <?php if ($invitation['CRPlace'] || $invitation['RPlace']) : ?>
    <section id="ceremonies" class="ceremonies">
      <?php if ($invitation['CRPlace']) : ?>
        <div>
          <div class="date">
            <?= getDateTimeWithStrFormat(date("Y-m-d H:i:s", strtotime(str_replace('/', '-', $invitation['CRDateTime'])))); ?>
          </div>
      ...
      <?php if ($invitation['RPlace']) : ?>
        <div>
          <div class="date">
            <?= getDateTimeWithStrFormat(date("Y-m-d H:i:s", strtotime(str_replace('/', '-', $invitation['RDateTime'])))); ?>
          </div>
