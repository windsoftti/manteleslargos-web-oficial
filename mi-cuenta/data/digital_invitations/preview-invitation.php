...
$href     = $url_host . 'invitaciones/' . $invitation_slug . '/' . $invitation_id;
?>
<!DOCTYPE html>
<html lang="es">
  ...
  <main class="main">
          ...
          <div id="container" style="height: 90vh;">
            <div id="theTarget">
              <?php while ($row = mysqli_fetch_array($query_result)) :
                $image_gallery = $url_host . 'images/invitaciones-digitales/galeria/' . $row['Imagen']
              ?>
                <div style="background-image: url(<?= $image_gallery; ?>)"></div>
              <?php endwhile; ?>
            </div>
          </div>
        </div>
    ...
    <section id="confirm-assistance" class="pure-g confirm-assistance-section">
      ...
      <div class="pure-u-1 confirm-assistance-button-container">
        <a class="pure-button confirm-assistance-button" target="_blank" href="https://api.whatsapp.com/send?phone=<?= $phone; ?>&text=Confirmo%20asistencia%20al%20evento%20de%20<?= $person_name; ?>">
